...
public abstract class Dictionary {
     ...
     // Inserts node in the dictionary and returns the corresponding Dictionary
     ...
     // The getFirst() returns the first element of the dictionary and null if the
     // dictionary is empty
